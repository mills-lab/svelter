...
import os
CSV_type_1=['ab/ab_ab/aba^','ab/ab_ab/b^ab','ab/ab_ab/b^a^b'] 
CSV_type_2=['abc/abc_abc/b^','abc/abc_abc/ac^','abc/abc_abc/a^c','abc/abc_abc/a^c^','abc/abc_abc/c^a^']
CSV_type_3=['abc/abc_abc/aba','abc/abc_abc/cbc']
CSV_type_4=['abc/abc_abc/aba^','abc/abc_abc/c^bc','abc/abc_abc/aca^']
for k1 in os.listdir('./'):
	if k1.split('.')[-1]=='stat' and not k1=='BPLink.Integrated.Categorized.stat':
		filein=k1
