...
5. with large sample size (eg. >50X whole genome sequencing), it is recommended that the parameter *--null-copyneutral-perc 0.01* added to your command,   with small ones (eg. < 10x), *--null-copyneutral-perc 0.5* is recommended.   This parameter decides the number of CN2 regions extracted for building null model.
