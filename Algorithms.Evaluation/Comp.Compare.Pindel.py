...
#!python
#command='Comp.Compare.Pindel.py --ref_genome /nfs/remills-scratch/datasets/Simulation.Xuefang/reference.flux/human_g1k_v37.fasta -p /nfs/remills-scratch/datasets/Simulation.Xuefang/Simulate.comp/Pindel/ --ref /nfs/remills-scratch/datasets/Simulation.Xuefang/Simulate.comp/comp.SV.rec'
