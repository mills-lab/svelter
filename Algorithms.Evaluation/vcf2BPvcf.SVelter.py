...
#!python
#command='python SVelter.vcf2BPvcf.py --ref /nfs/remills-scratch/datasets/Simulation.Xuefang/reference.flux/human_g1k_v37.fasta -p /nfs/remills-scratch/datasets/Simulation.Xuefang/Simulate.comp/SVelter/bp_files.Simulate.comp.RD.10.RL.101.sorted.bam/Simulate.comp.RD.10.RL.101.sorted/SPCff3.CluCff3.AlignCff0.0/ --prefix SVelter_comp_RD_10'
...
import time
import datetime
opts,args=getopt.getopt(sys.argv[1:],'p:',['ref=','prefix=','appdix='])
dict_opts=dict(opts)
