...
if dict_opts['--server']=='axiom':
        ...
        for k1 in os.listdir(ppre):
                if k1.split('.')[-1]=='rec':
                        ...
                        print >>fo, ' '.join(['Pacbio.Vali.CSV.py --ppre',out_path,'--bam',bam_NA12878,'--ref',ref,'-i',ppre+k1,'--Path_Pindel /mnt/EXT/Mills-data/xuefzhao/projects/Pedigree1463.axiom/NA12878/Pindel --Path_Delly /mnt/EXT/Mills-data/xuefzhao/projects/Pedigree1463.axiom/NA12878/Delly --Path_Lumpy /mnt/EXT/Mills-data/xuefzhao/projects/Pedigree1463.axiom/NA12878/Lumpy'])
                        fo.close()
        ...
        for k1 in os.listdir(ppre):
                if k1.split('.')[-1]=='rec':
                        ...
                        out_path=ppre+JobToDo
                        print >>fo, ' '.join(['mkdir',out_path])
                        print >>fo, ' '.join(['Pacbio.Vali.CSV.py --ppre',out_path,'--bam',bam_NA12878,'--ref',ref,'-i',ppre+k1,'--Path_Delly /nfs/remills-data/xuefzhao/projects/Pedigree1463.axiom/NA12878/Delly --Path_Lumpy /nfs/remills-data/xuefzhao/projects/Pedigree1463.axiom/NA12878/Lumpy'])
                        #print >>fo, ' '.join(['Pacbio.Vali.Rsquare.DEL.py','--bam',bam_NA12878,'--ref',ref,'--ppre',out_path,'-i',ppre+k1])
                        fo.close()
