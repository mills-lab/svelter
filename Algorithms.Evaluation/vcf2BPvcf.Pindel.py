...
#!python
#command='python SVelter.vcf2BPvcf.py --ref /nfs/remills-scratch/datasets/Simulation.Xuefang/reference.flux/human_g1k_v37.fasta -p /nfs/remills-scratch/datasets/Simulation.Xuefang/Simulate.comp/Pindel/ --prefix Pindel.comp.RD.10.LargerThan10'
