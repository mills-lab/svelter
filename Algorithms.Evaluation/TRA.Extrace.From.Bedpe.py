...
#!python
#command='TRA.Extrace.From.Bedpe.py -i /mnt/EXT/Mills-scratch/datasets/Simulation.Xuefang/Simulate.het/Lumpy/bedpe/Simulate_het_RD50_pesr.DEL.Mappable.bedpe --ref /mnt/EXT/Mills-scratch/datasets/Simulation.Xuefang/Simulate.het/sv_new.rec/het_new.het.TRA.rec'
				...
				for x1 in ref_list[k1]:
					if x2[-1]<x1[1]: continue
						...
						if bp_result[0]>1:
							...
							out[k1]['_'.join([str(i) for i in x1])].append(x2)
							out2.append(x2)
	return [out,out2]		
