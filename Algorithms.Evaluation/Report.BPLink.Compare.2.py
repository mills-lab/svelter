...
#!python
#command='python Report.BPLink.Compare.2.py --ref /nfs/remills-scratch/datasets/Simulation.Xuefang/reference.flux/human_g1k_v37.fasta -i /nfs/remills-scratch/datasets/Simulation.Xuefang/Simulate.homo/TRA.Compare.Report/SVelter_RD10_comp.SV.compare.report'
