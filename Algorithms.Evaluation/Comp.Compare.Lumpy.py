...
#!python
#command='Comp.Compare.Lumpy.py --ref_genome /nfs/remills-scratch/datasets/Simulation.Xuefang/reference.flux/human_g1k_v37.fasta -p /nfs/remills-scratch/datasets/Simulation.Xuefang/Simulate.comp/Lumpy/ --ref /nfs/remills-scratch/datasets/Simulation.Xuefang/Simulate.comp/comp.SV.rec'
