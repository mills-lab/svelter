...
if len(sys.argv)<2:
    ...
    if function_name=='Clean':
        ...
        if dict_opts=={} or dict_opts.keys()==['-h'] or dict_opts.keys()==['--help']:
            print_default_parameters_clean()
        else:
    ...
    if function_name=='Setup':
        ...
        if dict_opts=={} or dict_opts.keys()==['-h'] or dict_opts.keys()==['--help']:
            print_default_parameters_setup()
        else:
            import numpy
            import scipy
            import math
            ...
            def final_regions_decide(Gap_Hash_Ref1,hash_Cor,chrom):
                ...
                return calculate_interval_region(temp3_list,Chromo_Length)
    ...
    if function_name=='NullModel':
        ...
        if dict_opts=={} or dict_opts.keys()==['-h'] or dict_opts.keys()==['--help']:
            print_default_parameters_nullmodel()
        else:
            import numpy
            import scipy
            import math
    ...
    if function_name=='BPSearch':
        ...
        CN2_Region={}
        if dict_opts=={} or dict_opts.keys()==['-h'] or dict_opts.keys()==['--help']:
            print_default_parameters_bpsearch()
        else:
    ...
    if function_name=='BPIntegrate':
        ...
        dict_opts=dict(opts)
        if dict_opts=={} or dict_opts.keys()==['-h'] or dict_opts.keys()==['--help']:
            print_default_parameters_bpintegrate()
        else:
    ...
    if function_name=='SVPredict':
        ...
        dict_opts=dict(opts)
        if dict_opts=={} or dict_opts.keys()==['-h'] or dict_opts.keys()==['--help']:
            print_default_parameters_svpredict()
        else:
            import os
            import sys
            import getopt
    ...
    if function_name=='SVIntegrate':
        ...
        dict_opts=dict(opts)
        if dict_opts=={} or dict_opts.keys()==['-h'] or dict_opts.keys()==['--help']:
            print_default_parameters_svintegrate()
        else:
    ...
    if function_name=='PredefinedBP':
        ...
        dict_opts=dict(opts)
        if dict_opts=={} or dict_opts.keys()==['-h'] or dict_opts.keys()==['--help']:
            print_default_parameters_predefinedbp()
        else:
            import time
            import datetime
