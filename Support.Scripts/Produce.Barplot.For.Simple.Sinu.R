...
#!R
#Usage: Rscript Produce.Barplot.For.Simple.Simu.R input-file
...
#Fuzzy.Junc.Data
data_in=read.csv(Input_file,sep=' ')
...
Het_SVelter=Het_SVelter[order(Het_SVelter[,2]),]
...
Het_Delly=Het_Delly[order(Het_Delly[,2]),]
Het_Delly=Het_Delly[order(Het_Delly[,3]),]
Het_Lumpy=Het_Lumpy[order(Het_Lumpy[,2]),]
Het_Lumpy=Het_Lumpy[order(Het_Lumpy[,3]),]
Het_SVelter=Het_SVelter[order(Het_SVelter[,2]),]
Het_SVelter=Het_SVelter[order(Het_SVelter[,3]),]
Het_Pindel=Het_Pindel[order(Het_Pindel[,2]),]
Het_Pindel=Het_Pindel[order(Het_Pindel[,3]),]
RD10_Stat=cbind(Het_SVelter[Het_SVelter[,3]==10,][,7],
  Het_Delly[Het_Delly[,3]==10,][,7],
  Het_Lumpy[Het_Lumpy[,3]==10,][,7],
  Het_Pindel[Het_Pindel[,3]==10,][,7],
  Het_SVelter[Het_SVelter[,3]==10,][,8],
  Het_Delly[Het_Delly[,3]==10,][,8],
  Het_Lumpy[Het_Lumpy[,3]==10,][,8],
  Het_Pindel[Het_Pindel[,3]==10,][,8])
RD20_Stat=cbind(Het_SVelter[Het_SVelter[,3]==20,][,7],
  Het_Delly[Het_Delly[,3]==20,][,7],
  Het_Lumpy[Het_Lumpy[,3]==20,][,7],
  Het_Pindel[Het_Pindel[,3]==20,][,7],
  Het_SVelter[Het_SVelter[,3]==20,][,8],
  Het_Delly[Het_Delly[,3]==20,][,8],
  Het_Lumpy[Het_Lumpy[,3]==20,][,8],
  Het_Pindel[Het_Pindel[,3]==20,][,8])
RD30_Stat=cbind(Het_SVelter[Het_SVelter[,3]==30,][,7],
  Het_Delly[Het_Delly[,3]==30,][,7],
  Het_Lumpy[Het_Lumpy[,3]==30,][,7],
  Het_Pindel[Het_Pindel[,3]==30,][,7],
  Het_SVelter[Het_SVelter[,3]==30,][,8],
  Het_Delly[Het_Delly[,3]==30,][,8],
  Het_Lumpy[Het_Lumpy[,3]==30,][,8],
  Het_Pindel[Het_Pindel[,3]==30,][,8])
RD40_Stat=cbind(Het_SVelter[Het_SVelter[,3]==40,][,7],
  Het_Delly[Het_Delly[,3]==40,][,7],
  Het_Lumpy[Het_Lumpy[,3]==40,][,7],
  Het_Pindel[Het_Pindel[,3]==40,][,7],
  Het_SVelter[Het_SVelter[,3]==40,][,8],
  Het_Delly[Het_Delly[,3]==40,][,8],
  Het_Lumpy[Het_Lumpy[,3]==40,][,8],
  Het_Pindel[Het_Pindel[,3]==40,][,8])
RD50_Stat=cbind(Het_SVelter[Het_SVelter[,3]==50,][,7],
  Het_Delly[Het_Delly[,3]==50,][,7],
  Het_Lumpy[Het_Lumpy[,3]==50,][,7],
  Het_Pindel[Het_Pindel[,3]==50,][,7],
  Het_SVelter[Het_SVelter[,3]==50,][,8],
  Het_Delly[Het_Delly[,3]==50,][,8],
  Het_Lumpy[Het_Lumpy[,3]==50,][,8],
  Het_Pindel[Het_Pindel[,3]==50,][,8])

write.csv(RD10_Stat,gsub('.Stats','.RD10.csv',Input_file))
write.csv(RD20_Stat,gsub('.Stats','.RD20.csv',Input_file))
write.csv(RD30_Stat,gsub('.Stats','.RD30.csv',Input_file))
write.csv(RD40_Stat,gsub('.Stats','.RD40.csv',Input_file))
write.csv(RD50_Stat,gsub('.Stats','.RD50.csv',Input_file))


pdf(file=gsub('.Stats','.Barplot.pdf',Input_file))
