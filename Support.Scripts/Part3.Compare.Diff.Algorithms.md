...
```
grep -v LowQual SVelter.vcf> SVelter_QC.vcf
```
##Step2. Extract simple SVs from vcf file to write in bed format.
SV.Output.Process.py vcf --input SVelter_QC.vcf
##Step3. Extract only SVs within mappable gemoic regions:
SV.Output.Process.py Mappable-Control --input SVelter_QC.DEL.bed --ref-prefix /scratch/remills_flux/xuefzhao/reference/GRCh37_decoy/human_g1k_v37_decoy.Mappable
