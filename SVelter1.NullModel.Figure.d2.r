...
StatMatrix=rbind(colnames(StatMatrix1),c(StatMatrix1[1,]),colnames(StatMatrix4),c(StatMatrix4[1,]))
#StatMatrix=rbind(colnames(StatMatrix1),c(StatMatrix1[1,]),colnames(StatMatrix2),c(StatMatrix2[1,]),colnames(StatMatrix3),c(StatMatrix3[1,]),colnames(StatMatrix4),c(StatMatrix4[1,]))
